package com.github.idnbso.hit.java.assignments.innerclasses.additionalmembers;
...
public class ReflectionDemo
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            System.out.println("The following report regards " + name + " : \n");
            if (!printSuperClasses(classObj))
            {
                System.out.println("This classObj doesn't" + " extend any other classObj !");
            }
